...
import 'package:flutter_animate/flutter_animate.dart'; // 🔔 NEW: Animations වලට
  ...
  Future<void> _submitAction() async {
    ...
    try {
      if (isAdmin) {
        ...
        // --- පරණ බිල් වලින් අයිතිකාරයාව හොයාගැනීම ---
        ...
        // --- CUSTOMER: PERMANENT LINK ---
        if (user != null) {
          // 1. මේ අංකය එයාගේ ගිණුමේ ස්ථිරවම සේව් කරනවා
          ...
          // 2. මේ අංකයට අදාළව දැනට තියෙන ඔක්කොම බිල් එයාගේ නමට හරවනවා
