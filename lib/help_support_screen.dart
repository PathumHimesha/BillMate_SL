...
class _HelpSupportScreenState extends State<HelpSupportScreen> {
  ...
  // User message eka yawana function eka
  void _sendMessage() {
    ...
    setState(() {
      ...
      _controller.clear();
      _isTyping = true; // Bot type karana bawa pennanna
    });
    
    _scrollToBottom();

    // Thathpara 1k inna (Bot hithanawa wage pennanna)
    Future.delayed(const Duration(milliseconds: 1000), () {
      _generateBotResponse(userText.toLowerCase());
    });
  }

  // --- SMART AUTO-REPLY LOGIC ENGINE ---
